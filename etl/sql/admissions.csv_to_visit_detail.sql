...
SELECT
    ...
    admissions.csv.admission_type AS visit_detail_concept_id,

 -- [MAPPING   LOGIC] DATETIME to DATE 
    admissions.csv.admittime AS visit_detail_start_date,
 ...
 -- [!WARNING!] no source column found. See possible comment at the INSERT INTO
    ...
    admissions.csv.admission_location AS admitted_from_concept_id,
    ...
    admissions.csv.discharge_location AS discharged_to_concept_id,
