...
unpacked_features as (
    select
        ...
        case 
            ...
            when dim_name = 'aperio_exposure_time' then 'Exposure Time'
        ...
        case 
            ...
            when dim_name = 'aperio_exposure_time' then NULLIF(svs_metadata.aperio_exposure_time::text, '')
        ...
        case
            ...
            when dim_name = 'aperio_exposure_time' then NULLIF('millisecond', '')
    ...
    from
        ...
        unnest(
            ...
            array[
                ...
                'aperio_scan_warning', 'aperio_exposure_time'
            ],
            array[
...
mapped_features as (
    ...
    on 
        u.unit_source_value = stcm_unit.source_code_description
)
